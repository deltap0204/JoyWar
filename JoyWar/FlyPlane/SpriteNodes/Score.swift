...
class Score: SKSpriteNode {
    ...
    init() {
        ...
        score1stDigit.position = CGPoint(x: 0, y: 0)
        score1stDigit.hidden = true
    ...
    func updateScoresCount() {
        let scoresInNumberOfDigits:String = isHighScore ? "\(getHighScoreFromGameData())" : "\(getScoreFromGameData())"
