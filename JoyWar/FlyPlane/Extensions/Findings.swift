...
//        lollipop.position = CGPoint(x: hurdleAtBottom.position.x, y: hurdleAtBottom.position.y + hurdleAtBottom.size.height / 2)
//        hurdlePair.addChild(lollipop)
...
//        lollipopAtTop.position = CGPoint(x: hurdleAtTop.position.x, y: hurdleAtTop.position.y - hurdleAtTop.size.height / 2)
